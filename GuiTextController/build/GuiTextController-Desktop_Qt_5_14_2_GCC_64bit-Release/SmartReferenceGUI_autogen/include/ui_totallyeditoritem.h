...
public:
    ...
    void setupUi(QWidget *TotallyEditorItem)
    {
        ...
        pushButton_2 = new QPushButton(pgControl);
    ...
    void retranslateUi(QWidget *TotallyEditorItem)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("TotallyEditorItem", "\320\243\320\264\320\260\320\273\320\270\321\202\321\214", nullptr));
